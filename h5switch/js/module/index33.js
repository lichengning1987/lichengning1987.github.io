	 ...
	 var mdate = new Date();
      ...
      objs.each(function(index,item){
          ...
          if(state == 'notBegin'){
            ...
            $('.goods-'+id).find(".info").addClass("notBegin");
            $('.goods-'+id).find(".info").html("距抢购开始还有");
            $('.goods-'+id).find(".time-wrap").addClass("notBegin");
            $('.goods-'+id).find('.time-wrap').activeCountDown(option,function(){
                  setTimeout(function(){
                      ...
                      $('.goods-'+id).find(".info").html("距抢购结束还有");
          ...
          if(state == 'begin'){
              ...
              $('.goods-'+id).find(".info").html("距抢购结束还有");
              $('.goods-'+id).find(".info").addClass("begin");
              $('.goods-'+id).find(".time-wrap").addClass("begin");
              $('.goods-'+id).find('.time-wrap').activeCountDown(option,function(){
                   setTimeout(function(){
                        $('.goods-'+id).find(".buyTime").data("state","end");
          ...
          //抢购结束
          if(state == 'end'){
               $('.goods-'+id).find(".info").addClass("end");
               $('.goods-'+id).find(".time-wrap").addClass("end");
               $('.goods-'+id).find(".info").html("限时抢购");
               $('.goods-'+id).find(".notime").removeClass("hide");
          }
