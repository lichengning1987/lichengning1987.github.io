...
address.adinit = function(){
    ...
    var otopheight=$(".address .title").height()+10;
    var startX=0,startY=0,swipSpanX=0,swipSpanY=0,omt=true;
    $("textarea#address").click(function(){
       $(".address .title").animate({"marginTop":-otopheight+"px"},300);
       omt=true;
    });
     ...
     $(document).on("touchstart",function(e){
	  ...
	  $(document).on("touchmove",function(e){
	          ...
	          if($(window).scrollTop() <= 10){
	               if(swipSpanY>0){
	                   e.preventDefault();
                       if(swipSpanY >= otopheight){
                          omt = false;
                          swipSpanY = 0;
                           $(".address .title").css({"marginTop":"0px"})
                       }
                       if(omt){
                         $(".address .title").css({"marginTop":-otopheight+swipSpanY+"px"})
                       }
	               }
	          }
	   });
