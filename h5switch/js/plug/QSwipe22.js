    ...
    $.fn.QSwipe = function(options,callback){
        ...
        function _addEvtHandler(){
            ...
            function restMovePos(){
                if(_way==="up"){
                    loopIndexChk("translate3d(0,-100%,0)","translate3d(0,100%,0)");
            ...
            function endWithNormalTran(){
                ...
                if(!_canElemMove){
                    if(_way==="up") {
                        curTransformVal = "translate3d(0, 0,0)";
                        sibTransformVal = "translate3d(0, 100%,0)";
                    }else if(_way==="down") {
                        curTransformVal = "translate3d(0, 0,0)";
                        sibTransformVal="translate3d(0,-100%,0)";
                    }else if(_way==="left") {
                        curTransformVal = "translate3d(0, 0,0)";
                        sibTransformVal="translate3d(100%,0,0)";
                    }else if(_way==="right") {
                        curTransformVal = "translate3d(0, 0,0)";
                        sibTransformVal="translate3d(-100%,0,0)";
                    }
                    ...
                    if(_way==="up"){
                        curTransformVal="translate3d(0,-100%,0)";
                        sibTransformVal="translate3d(0, 0,0)";
                        _index++;
                    }else if(_way==="down"){
                        curTransformVal="translate3d(0,100%,0)";
                        sibTransformVal="translate3d(0, 0,0)";
                        ...
                        curTransformVal="translate3d(-100%,0,0)";
                        sibTransformVal="translate3d(0, 0,0)";
                        _index++;
                    }else{
                        curTransformVal="translate3d(100%,0,0)";
